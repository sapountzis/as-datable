      ...
      <div className="section-container relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 text-sm text-muted-foreground hover:text-foreground bg-secondary/50 rounded-full border border-border hover:border-primary/30 transition-all"
        ...
        <div className="mt-16">
          <div className="flex flex-wrap justify-center gap-4 md:gap-6">
            {proofMetrics.map((metric) => (
              <div
                key={metric}
                className="px-4 py-2 text-sm font-medium text-foreground bg-secondary/50 rounded-lg border border-border"
              >
                {metric}
              </div>
            ))}
        ...
        {/* Client logos */}
        <div className="mt-16">
          <p className="text-sm text-muted-foreground text-center mb-6">Worked with</p>
